...
{
    public class GameplayScreen_Heal : GameScreen
    {
        Player player;
        World world;
        Camera camera;
        ...
        public override void LoadContent()
        {
            ...
            player.LoadContent();
            world = worldLoader.Load("Content/Load/Gameplay/World/Blue_Heal.xml");
            world.LoadContent();
        ...
        public override void UnloadContent()
        {
            ...
            if (ScreenManager.Instance.CurrentMapName.Contains("Wild"))
                ScreenManager.Instance.PlayerPosition = new Vector2(8, 13) * 128;
            else
                ScreenManager.Instance.PlayerPosition = new Vector2(6, 5) * 128;
            //TO DELETE LATER...
